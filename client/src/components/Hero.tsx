  ...
  return (
    <div>
      <section className="flex flex-col justify-center items-center w-full px-4 sm:px-8 md:px-16">
        ...
        {/* Contenedor de redes y botón CV */}
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-4 mb-10 w-full"/>
          ...
          {/* Botón Descargar CV debajo en móviles */}
          <a
            href="/Gabriel Caldubehere.pdf"
            download
            className="mt-2 sm:mt-0 px-4 py-2 sm:px-6 sm:py-2 rounded-full shadow-md transition-transform duration-300 hover:scale-105 font-semibold text-stone-100 text-sm sm:text-base"
            style={{
